...
class SignupHandler {
    constructor() {
        console.log('SignupHandler constructor called');
        ...
        console.log('Form elements found:', {
            ...
            dobInput: !!this.dobInput
        });
        
        // Test if we can access the form elements
        if (this.nameInput) {
            console.log('Name input found, value:', this.nameInput.value);
        } else {
    ...
    init() {
        console.log('SignupHandler init called');
        if (!this.form) {
    ...
    async submitSignup() {
        ...
        try {
            ...
            if (!this.nameInput || !this.emailInput || !this.passwordInput || !this.dobInput) {
                ...
                this.showMessage('Form error. Please refresh the page and try again.', 'error');
                return;
            }
            ...
            console.log('- name:', this.nameInput?.value || 'null');
            console.log('- email:', this.emailInput?.value || 'null');
            console.log('- password:', this.passwordInput?.value || 'null');
            console.log('- dob:', this.dobInput?.value || 'null');
